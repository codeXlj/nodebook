...
2.`<input  type = "redio" />`{=html}，则v-model收集的是value的值，且要给value配置；
...
### 01.页面禁止复制和右键禁用功能 {#01页面禁止复制和右键禁用功能}
...
### 03.上传码云并发布部署静态网站 {#03上传码云并发布部署静态网站}
