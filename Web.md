...
app.all("*",(req,res,next)=>{
  if( req.headers.origin.toLocaleLowerCase()=="https://www.helloaxlj.top" || 
  req.headers.origin.toLocaleLowerCase()=="http://localhost:8080"){
...
app.all("*",(req,res,next)=>{
  if( req.headers.origin=="https://www.helloxlj.top" || req.headers.origin=="https://www.11e.fun" 
...
### 1、TypeScript 开发环境搭建 {#1typescript-开发环境搭建}
...
### 12.配置别名后vscode给与提示 {#12配置别名后vscode给与提示}

-   1.根目录创建`jsconfig.json`文件
...
### 13.Vue3-Vue-router4 keep-alive的使用 {#13vue3-vue-router4-keep-alive的使用}
